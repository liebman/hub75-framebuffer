...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.0", features = ["esp-hal-dma"] }
```
...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.0", features = ["esp32-ordering"] }
```
...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.0", features = ["blank-delay-4"] }
```
...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.0", 
