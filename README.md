...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.1", features = ["esp-hal-dma"] }
```
...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.1", features = ["blank-delay-4"] }
```
...
```toml
[dependencies]
hub75-framebuffer = { version = "0.9.1", 
